...
parameters/
scripts/
├── 00_config.R                                  # Central configuration (paths, thresholds)
...
| Step | Script 
|---|---|---|
| 1 | `00_config.R` | Sourced automatically |
| 2 | `1-make_data_dict.R` | `qsub run_pipeline.sh` or `Rscript 1-make_data_dict.R /path/to/ukb.tab` |
| — | ⏸ **Manual step** | Fill in `parameters/selection.xlsx` (CodingName, FigureName, InstanceRequired) |
| 3 | `2-extract_selected.R` 
| 4 | `3-recode_variables_change.R` 
| 5 | `4-recoding.R` 
| 6 | `5-collapsing.R` 
| 7 | `5.5-feature_engineering.R` 
| 8 | `6-preprocessing.R` 
| 9 | `7-cleaning.R` 
| 10 | `8-imputation_full_dataset.R` 
| 11 | `9-table1.R` 
| 12 | `10-dataset_splitting.R` 
| 13a | `11a_impute_selection.R` 
| 13b | `11b_impute_refit.R` 
| 13c | `11c_impute_test.R` 
| 14 | `11d_relevel_imputed_splits_adjusted_ref.R` 

### Running the full pipeline at once

Steps 1–7 and 9–11, 14, 17 can all be run together via the master pipeline script:
```
# Submit on the HPC
                                            ...
                                            └── 5.5-feature_engineering.R  ──► ukb_collapsed2.rds
                                                    └── 6-preprocessing.R  ──► ukb_collapsed3.rds
                                                            └── 7-cleaning.R  ──► ukb_cleaned.rds
                                                                    ├── 8-imputation_full_dataset.R  ──► ukb_final_ruben_imputed_500k.rds
